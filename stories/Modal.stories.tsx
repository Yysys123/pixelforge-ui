...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'Accessible modal dialog component with focus trapping, backdrop click handling, and keyboard navigation. Includes brutalist design elements and customizable content areas.',
      },
    },
  },
  tags: ['autodocs'],
...
const ModalDemo = ({ modalProps, buttonText = 'Open Modal', ...props }: any) => {
  ...
  render: () => (
    <ModalDemo
      ...
      modalProps={{
        children: (
          <div>
            <p>This is a basic modal with some content. You can put any React elements here.</p>
            <p>The modal includes focus trapping and keyboard navigation for accessibility.</p>
          </div>
        ),
      }}
    />
        ...
        children: (
          <div>
            ...
            <div style={{ background: '#f5f5f5', padding: '1rem', margin: '1rem 0', borderRadius: '4px' }}>
              ...
              <p style={{ margin: 0 }}>You can put complex layouts and multiple sections here.</p>
            </div>
          </div>
        ),
      }}
      ...
      modalProps={{
        ...
        children: (
          <div>
            ...
            <p>You can still close it by clicking the backdrop or pressing ESC.</p>
            <Button 
              onClick={() => {}} 
